...
export interface Env {
  ...
  // Plugin URLs (for development vs production)
  TWITTER_PLUGIN_URL?: string;
  FARCASTER_PLUGIN_URL?: string;
...
export  function getEnv(): Env {
  return {
    ...
    TWITTER_PLUGIN_URL: Deno.env.get('TWITTER_PLUGIN_URL'),
    FARCASTER_PLUGIN_URL: Deno.env.get('FARCASTER_PLUGIN_URL'),

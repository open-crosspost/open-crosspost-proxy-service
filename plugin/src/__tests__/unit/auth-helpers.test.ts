...
import { generateAuthToken, createAuthHeaders, isValidNearAuthData } from "../../utils/auth-helpers";
...
describe("Auth Helpers", () => {
  ...
  describe("isValidNearAuthData", () => {
    ...
    it("should accept auth data with optional callback_url", () => {
      const dataWithCallback = { ...mockNearAuthData, callback_url: "https://example.com/callback" };

 ...
 */
async function manageKV(listOnly: boolean, prefix: string | null, skipConfirmation: boolean): Promise<void> {
  ...
  try {
    console.log(`🔍 Listing ${prefix ? `keys with prefix '${prefix}'` : "all keys"} in the database...`);
